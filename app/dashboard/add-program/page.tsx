        ...
        <div className="flex flex-row gap-2">
          <Card className="w-1/2">
            ...
            <Card.Title className="text-lg font-bold">
              Make a new help channel for a program
            </Card.Title>
            <Card.Description className="text-gray-400">
              Instantly make a help channel for your program that&apos;s managed
              through Unified Help, including a help channel with a bot. Helpers
              resolve and respond to tickets within Slack or Unified Help, and
              you can manage your program within the Unified Help website. To
              use this option, sign in with a @hackclub.com email.
            </Card.Description>
          </Card>
          <Card className="w-1/2">
            <Card.Header>
